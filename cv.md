...
[LightSpeed Broadband](https://www.lightspeed.co.uk) are a challenger ISP.
...
[AND Digital](https://www.and.digital) is a digital consultancy aiming to close the world's digital skills gap.
...
Over 6 million users across [iOS](https://apps.apple.com/gb/app/my-sky/id880575127) and [Android](http://Android) use the My Sky app. It is the primary way customers manage their Sky products, configure their WiFi Max Routers, and administer their accounts.
...
- Led a team of 25 developers (Native iOS, Native Android, ASP.NET, Vue.js) to build the [RailSmart](https://www.velociti-solutions.com/our-solutions/railsmart-software-suite/) software suite. Implemented a cohesive and inclusive team vision and management approach.
...
- Standardised iOS components into small, reusable packages, first with CocoaPods and then SPM. Used them across all new and old projects and open-sourced as [The Peak Framework](https://github.com/topics/peak-framework) on GitHub.
...
### Leeds Mobile － [www.leedsmobile.com](http://www.leedsmobile.com)
...
### Public Speaking － [stringer.dev/talks](https://stringer.dev/talks)
...
### Pivot for iOS － [https://www.linkedin.com/company/getpivotapp/](https://www.linkedin.com/company/getpivotapp/)

- Developed in 2021, users can build, configure and visualise pivot tables like Microsoft Excel.
- Used TDD to build a Swift algorithm to parse a CSV file into a pivot table. Open-sourced as [PeakPivot](https://github.com/3Squared/PeakPivot).
